...
class Cache_Session_Handler
{
	...
	public function __construct()
	{
		...
		if( ! $this->_CI->load->is_loaded('cache'))
		{
			...
			/**
			 * @author Xie Biao<hhxsv5@sina.com>
			 */
			if(!config_item('sess_save_handler')){
				die('Must set sess_save_handler to replace the cookie handler in config.php');
			}
			$this->_CI->load->driver(
				'cache',
				array('adapter' => config_item('sess_save_handler'), 'backup' => config_item('sess_save_handler_backup')
			));
		}
	}
